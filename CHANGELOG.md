...
## [4.3.0](https://github.com/moxystudio/postcss-preset-moxy/compare/v4.2.0...v4.3.0) (2019-09-16)


### Features

* add ability to disable cssVariables ([52862a1](https://github.com/moxystudio/postcss-preset-moxy/commit/52862a1))



## [4.2.0](https://github.com/moxystudio/postcss-preset-moxy/compare/v4.1.2...v4.2.0) (2019-09-13)


### Features

* allow to customize cssVariables options ([17da1e8](https://github.com/moxystudio/postcss-preset-moxy/commit/17da1e8))



### [4.1.2](https://github.com/moxystudio/postcss-preset-moxy/compare/v4.1.1...v4.1.2) (2019-06-23)


### Bug Fixes

* fix media queries and variables combo being out of order ([b77efb8](https://github.com/moxystudio/postcss-preset-moxy/commit/b77efb8))
